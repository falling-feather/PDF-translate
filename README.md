...
| 译后质量闭环 | 本地生成 QA 报告、局部修复计划、补丁审核、发布确认、回滚演练、实验指标、双语 HTML 和结构化 PDF 译文报告，覆盖数字、引用、DocumentIR 表格形状、图注/脚注结构关系、术语一致性与术语冲突等基础检查 |
