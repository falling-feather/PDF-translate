...
6. **结构层**：`output/document_ir.json`、`output/structure_chunks_manifest.json`、`output/structure_qa.json`、`output/vision_route.json`（结构识别、结构分段预览、表格维度、页面边界碎片、页级 OCR/VLM 路由摘要）
