...
def map_bundle_arcname(rel_posix: str) -> str:
    ...
    output_map = {
        ...
        "output/vlm_review.json": "质量/VLM视觉复核报告.json",
        "output/vlm_review.md": "质量/VLM视觉复核报告.md",
        "output/vlm_results.json": "质量/VLM复核回写结果.json",
        "output/vlm_apply.json": "质量/VLM回写应用报告.json",
        "output/vlm_apply.md": "质量/VLM回写应用报告.md",
        "output/vlm_retranslation_plan.json": "质量/VLM重译计划.json",
        "output/vlm_retranslation_plan.md": "质量/VLM重译计划.md",
...
def iter_bundle_files(root: Path) -> list[Path]:
    ...
    candidates = [
        ...
        root / "output" / "vlm_review.json",
        root / "output" / "vlm_review.md",
        root / "output" / "vlm_results.json",
        root / "output" / "vlm_apply.json",
        root / "output" / "vlm_apply.md",
        root / "output" / "vlm_retranslation_plan.json",
        root / "output" / "vlm_retranslation_plan.md",
